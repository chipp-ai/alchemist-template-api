...
# ===========================================================================
# dev.sh — Start the development stack (API + Docker services)
#
# Usage:
#   ./scripts/dev.sh --api-port 8000
#
# --api-port is REQUIRED. The script refuses to start with defaults because
# multiple agents may run against the same repo in parallel worktrees.
# ===========================================================================
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    --api-port)
      ...
      ;;
    -h|--help)
      echo "Usage: ./scripts/dev.sh --api-port PORT"
      echo ""
